...
class TokenContractTest {
    ...
    void serializesClientWhenPresent() {
        ...
        assertThat(client.get("name").asString()).isEqualTo("Chrome");
        assertThat(client.get("os").asString()).isEqualTo("Linux");
        assertThat(client.get("device").asString()).isEqualTo("desktop");
    }
