package com.sajitar.backend.adapter.in.web.controller;
...
public class IntegrationAuth {
    ...
    public static IssuedSession openSession(
    ...
    public static String danglingRefreshToken(final WebApplicationContext context) {
        final var now = context.getBean(Clock.class).instant();
