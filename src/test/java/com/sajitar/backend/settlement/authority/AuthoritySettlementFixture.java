package com.sajitar.backend.settlement.authority;
...
public final class AuthoritySettlementFixture {
    ...
    public static final UUID ALICE_MEMBER_ID = UUID.fromString("019c2000-a112-7000-8000-222222222222");

    public static final UUID ALICE_READER_ID = UUID.fromString("019c2000-a113-7000-8000-333333333333");

    public static final UUID BRUNO_MASTER_ID = UUID.fromString("019c2000-b111-7000-8000-444444444444");
