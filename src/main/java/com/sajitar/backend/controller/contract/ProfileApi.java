...
@Tag(name = "Perfis", description = "Operações de criação, atualização e consulta de perfis.")
...
public interface ProfileApi {
    ...
    @Operation(
            ...
            description = "Atualiza um perfil existente. Quando a senha é informada, ela é recodificada antes da persistência.")
    @ApiResponse(
            responseCode = "200",
    ...
    @ProfileWriteErrorResponses
    @PutMapping
    ResponseEntity<ProfileSummaryResponse> putProfile(@Valid @RequestBody UpdateProfileRequest request);
